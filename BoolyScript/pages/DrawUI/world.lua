...
local objects = Submenu.add_static_submenu("Objects", "BS_World_Objects") do
    ...
    local spawnedObjectEditor = Submenu.add_static_submenu("Editor", "BS_World_Objects_Spawned_Editor") do
        ...
        local posStep = spawnedObjectEditor:add_float_option("Step", "BS_World_Objects_Spawned_Editor_Position_Step", 0.1, 30.0, 0.1):setValue(1.0):setConfigIgnore()
        ...
        local rotStep = spawnedObjectEditor:add_float_option("Step", "BS_World_Objects_Spawned_Editor_Rotation_Step", 0.1, 30.0, 0.1):setValue(1.0):setConfigIgnore()
